...
let body:.PluginsApiGetPluginCSIRequest = {
  // string | The CSI plugin identifier.
...
------------- | ------------- | ------------- | -------------
 **pluginID** | [**string**] | The CSI plugin identifier. | defaults to undefined
...
# **getPlugins**
> Array<CSIPluginListStub> getPlugins()
...
let body:.PluginsApiGetPluginsRequest = {
  // string | Filters results based on the specified region. (optional)
  region: "region_example",
  // string | Filters results based on the specified namespace. (optional)
  namespace: "namespace_example",
