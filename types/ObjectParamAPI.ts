...
export interface VariablesApiDeleteVariableRequest {
    /**
     * A path to a Nomad Variable
     * @type string
     * @memberof VariablesApideleteVariable
     */
    path: string
    /**
     * 
...
export interface VariablesApiGetVariableQueryRequest {
    /**
     * A path to a Nomad Variable
     * @type string
     * @memberof VariablesApigetVariableQuery
     */
    path: string
    /**
     * Filters results based on the specified region.
...
export interface VariablesApiGetVariablesListRequestRequest {
    /**
     * Filters results based on the specified region.
     * @type string
     * @memberof VariablesApigetVariablesListRequest
     */
    region?: string
    /**
     * Filters results based on the specified namespace.
...
export interface VariablesApiPostVariableRequest {
    /**
     * A path to a Nomad Variable
     * @type string
     * @memberof VariablesApipostVariable
     */
    path: string
    /**
     * 
...
export interface VariablesApiPutVariableRequest {
    /**
     * A path to a Nomad Variable
     * @type string
     * @memberof VariablesApiputVariable
     */
    path: string
    /**
     * 
...
export class ObjectVariablesApi {
     ...
     * @param param the request object
     */
    public deleteVariable(param: VariablesApiDeleteVariableRequest, options?: Configuration): Promise<void> {
        return this.api.deleteVariable(param.path, param.variable, param.region, param.namespace, param.xNomadToken, param.idempotencyToken, param.cas,  options).toPromise();
    }

    /**
     * @param param the request object
     */
    public getVariableQuery(param: VariablesApiGetVariableQueryRequest, options?: Configuration): Promise<Variable> {
        return this.api.getVariableQuery(param.path, param.region, param.namespace, param.index, param.wait, param.stale, param.prefix, param.xNomadToken, param.perPage, param.nextToken,  options).toPromise();
    }

    /**
     * @param param the request object
     */
    public getVariablesListRequest(param: VariablesApiGetVariablesListRequestRequest = {}, options?: Configuration): Promise<Array<VariableMetadata>> {
        return this.api.getVariablesListRequest(param.region, param.namespace, param.index, param.wait, param.stale, param.prefix, param.xNomadToken, param.perPage, param.nextToken,  options).toPromise();
    }

    /**
     * @param param the request object
     */
    public postVariable(param: VariablesApiPostVariableRequest, options?: Configuration): Promise<Variable> {
        return this.api.postVariable(param.path, param.variable, param.region, param.namespace, param.xNomadToken, param.idempotencyToken, param.cas,  options).toPromise();
    }

    /**
     * @param param the request object
     */
    public putVariable(param: VariablesApiPutVariableRequest, options?: Configuration): Promise<Variable> {
        return this.api.putVariable(param.path, param.variable, param.region, param.namespace, param.xNomadToken, param.idempotencyToken, param.cas,  options).toPromise();
    }
