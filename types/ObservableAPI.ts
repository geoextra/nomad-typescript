...
import { ChangeScript } from '../models/ChangeScript';
...
import { JobACL } from '../models/JobACL';
...
export class ObservableVariablesApi {
     ...
     */
    public deleteVariable(path: string, variable: Variable, region?: string, namespace?: string, xNomadToken?: string, idempotencyToken?: string, cas?: number, _options?: Configuration): Observable<void> {
        const requestContextPromise = this.requestFactory.deleteVariable(path, variable, region, namespace, xNomadToken, idempotencyToken, cas, _options);
     ...
     * @param nextToken Indicates where to start paging for queries that support pagination.
     */
    public getVariableQuery(path: string, region?: string, namespace?: string, index?: number, wait?: string, stale?: string, prefix?: string, xNomadToken?: string, perPage?: number, nextToken?: string, _options?: Configuration): Observable<Variable> {
        const requestContextPromise = this.requestFactory.getVariableQuery(path, region, namespace, index, wait, stale, prefix, xNomadToken, perPage, nextToken, _options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.getVariableQuery(rsp)));
            }));
    }
     ...
     * @param nextToken Indicates where to start paging for queries that support pagination.
     */
    public getVariablesListRequest(region?: string, namespace?: string, index?: number, wait?: string, stale?: string, prefix?: string, xNomadToken?: string, perPage?: number, nextToken?: string, _options?: Configuration): Observable<Array<VariableMetadata>> {
        const requestContextPromise = this.requestFactory.getVariablesListRequest(region, namespace, index, wait, stale, prefix, xNomadToken, perPage, nextToken, _options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.getVariablesListRequest(rsp)));
            }));
    }
     ...
     * @param cas A compare-and-set parameter for Nomad Variables
     */
    public postVariable(path: string, variable: Variable, region?: string, namespace?: string, xNomadToken?: string, idempotencyToken?: string, cas?: number, _options?: Configuration): Observable<Variable> {
        const requestContextPromise = this.requestFactory.postVariable(path, variable, region, namespace, xNomadToken, idempotencyToken, cas, _options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.postVariable(rsp)));
            }));
    }
     ...
     * @param cas A compare-and-set parameter for Nomad Variables
     */
    public putVariable(path: string, variable: Variable, region?: string, namespace?: string, xNomadToken?: string, idempotencyToken?: string, cas?: number, _options?: Configuration): Observable<Variable> {
        const requestContextPromise = this.requestFactory.putVariable(path, variable, region, namespace, xNomadToken, idempotencyToken, cas, _options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.putVariable(rsp)));
            }));
    }
