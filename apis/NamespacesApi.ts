 ...
 * no description
 */
export class NamespacesApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async createNamespace(region?: string, namespace?: string, xNomadToken?: string, idempotencyToken?: string, _options?: Configuration): Promise<RequestContext> {
     ...
     * @param idempotencyToken Can be used to ensure operations are only run once.
     */
    public async deleteNamespace(namespaceName: string, region?: string, namespace?: string, xNomadToken?: string, idempotencyToken?: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'namespaceName' is not null or undefined
        if (namespaceName === null || namespaceName === undefined) {
            throw new RequiredError("NamespacesApi", "deleteNamespace", "namespaceName");
        }
     ...
     */
    public async getNamespace(namespaceName: string, region?: string, namespace?: string, index?: number, wait?: string, stale?: string, prefix?: string, xNomadToken?: string, perPage?: number, nextToken?: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'namespaceName' is not null or undefined
        if (namespaceName === null || namespaceName === undefined) {
            throw new RequiredError("NamespacesApi", "getNamespace", "namespaceName");
        }
     ...
     * @param nextToken Indicates where to start paging for queries that support pagination.
     */
    public async getNamespaces(region?: string, namespace?: string, index?: number, wait?: string, stale?: string, prefix?: string, xNomadToken?: string, perPage?: number, nextToken?: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
     ...
     * @param idempotencyToken Can be used to ensure operations are only run once.
     */
    public async postNamespace(namespaceName: string, namespace2: Namespace, region?: string, namespace?: string, xNomadToken?: string, idempotencyToken?: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'namespaceName' is not null or undefined
        if (namespaceName === null || namespaceName === undefined) {
            throw new RequiredError("NamespacesApi", "postNamespace", "namespaceName");
        }


        // verify required parameter 'namespace2' is not null or undefined
        if (namespace2 === null || namespace2 === undefined) {
            throw new RequiredError("NamespacesApi", "postNamespace", "namespace2");
        }
        ...
        const serializedBody = ObjectSerializer.stringify(
            ObjectSerializer.serialize(namespace2, "Namespace", ""),
            contentType
        );
...
export class NamespacesApiResponseProcessor {
     ...
     */
     public async createNamespace(response: ResponseContext): Promise<void > {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async deleteNamespace(response: ResponseContext): Promise<void > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            return;
        }
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getNamespace(response: ResponseContext): Promise<Namespace > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to getNamespaces
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getNamespaces(response: ResponseContext): Promise<Array<Namespace> > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: Array<Namespace> = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
                "Array<Namespace>", ""
            ) as Array<Namespace>;
            return body;
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to postNamespace
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async postNamespace(response: ResponseContext): Promise<void > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            return;
        }
