...
let body:.NodesApiGetNodeRequest = {
...
let body:.NodesApiGetNodeAllocationsRequest = {
  // string | The ID of the node.
  nodeId: "nodeId_example",
  // string | Filters results based on the specified region. (optional)
  region: "region_example",
...
let body:.NodesApiGetNodesRequest = {
  // string | Filters results based on the specified region. (optional)
  region: "region_example",
  // string | Filters results based on the specified namespace. (optional)
  namespace: "namespace_example",
...
let body:.NodesApiUpdateNodeDrainRequest = {
  // string | The ID of the node.
  nodeId: "nodeId_example",
...
let body:.NodesApiUpdateNodeEligibilityRequest = {
  // string | The ID of the node.
  nodeId: "nodeId_example",
...
let body:.NodesApiUpdateNodePurgeRequest = {
  // string | The ID of the node.
  nodeId: "nodeId_example",
  // string | Filters results based on the specified region. (optional)
  region: "region_example",
